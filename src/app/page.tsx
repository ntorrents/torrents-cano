  ...
  return (
    <section className="relative flex min-h-[100svh] items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-4xl px-6 pb-16 pt-28 text-center md:px-10 md:pt-24">
        <p className="rise text-sm uppercase tracking-[0.28em] text-ink-soft">
          exposición permanente
        </p>
        <h1 className="rise rise-delay-1 mt-5 font-[family-name:var(--font-fraunces)] text-6xl leading-[0.95] tracking-tight text-ink md:text-8xl">
          Atelier
        </h1>
        <p className="rise rise-delay-2 mx-auto mt-6 max-w-md text-lg text-ink-soft md:text-xl">
        ...
        <div className="rise rise-delay-3 mt-10 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/galeria"
            className="rounded-full bg-ink px-7 py-3 text-sm font-medium text-paper transition hover:bg-ink/90"
          >
